...
tools: Bash(bd *), Read, Grep, Glob, mcp__octocode__localGetFileContent, mcp__octocode__localSearchCode, mcp__plugin_context-mode_context-mode__*
---
...
**Output budget:** one line per finding, ≤ 150 chars, grouped by evidence type. Total ≤ 1500 tokens. Bead comments are read in chunks and summarised — never echoed.
