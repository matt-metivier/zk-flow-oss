...
- **Blast radius of a flagged function**: `mcp__codebase-memory-mcp__trace_path` -- confirm the attack surface before rating severity
- **Find all callers of an auth function**: `mcp__codebase-memory-mcp__search_graph` with the function name
