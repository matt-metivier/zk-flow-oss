...
- **Blast-radius of a claim**: `mcp__codebase-memory-mcp__trace_path` — runs before asking "what happens if X changes?"
...
**Output budget:** one question per turn, ≤ 120 words. `challenges[].question` ≤ 150 chars each. Never restate the design back at the author.
