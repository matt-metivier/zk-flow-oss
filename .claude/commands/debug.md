...
Debug lifecycle: reproduce+root-cause -> fix -> test. Diagnoses a reported symptom to its ROOT CAUSE with file:line evidence, then fixes it and verifies with a regression test. Tighter than bugfix -- starts from a symptom, not a task.
