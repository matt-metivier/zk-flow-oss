...
|---|---|---|
| D-0.1 | Skill selection non-empty for non-trivial tasks | `selected_skills[]` populated when task touches known domain (clickhouse, k8s, rust, etc.) |
...
- Empty `selected_skills[]` is acceptable for tasks clearly outside any known domain skill
