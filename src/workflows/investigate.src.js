...
export const meta = {
  ...
  phases: [{title:'Signal'},{title:'Hypotheses'},{title:'Propose'}],
};
// @@FRAGMENTS@@
...
await agent(handoffPrompt(
  ...
  `/investigate bead=${beadId} to resume, or manually execute approved mitigations then /debug or /bugfix for root-cause fix.`
